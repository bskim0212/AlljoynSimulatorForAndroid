...
import com.lge.alljoyn.simulator.interfaces.controlpanel.CPContainerInterface;

public class ContainerMaker implements BusObject, CPContainerInterface {
	...
	public ContainerMaker(String _label, InterfaceObject obj) {
		this.label = _label;
