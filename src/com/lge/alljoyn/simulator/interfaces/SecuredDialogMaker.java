...
import com.lge.alljoyn.simulator.interfaces.controlpanel.CPDialogSecuredInterface;
...
public class SecuredDialogMaker implements BusObject, CPDialogSecuredInterface {
	...
	public SecuredDialogMaker(InterfaceObject _obj, String _propertyKey, String _deviceId) {
		this.obj = _obj;
