...
import org.alljoyn.about.AboutServiceException;
import org.alljoyn.about.Announcer;
...
public class AboutServiceImpl extends ServiceCommonImpl implements AboutService
{
    ...
    private  AboutServiceImpl m_instance;//      = new AboutServiceImpl();
     ...
     */
    public  AboutService getInstance()
    {
    	if (m_instance == null)
